<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"><?php echo $this->lang->line('Purchase').' '.$this->lang->line('Report') ?> 
            ...
            <div class="card-body">
                ...
                <table id="po" class="table table-striped table-bordered zero-configuration">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('Unit').' '.$this->lang->line('Price') ?></th>
        ...
        $(document).ready(function () {
            ...
            function draw_data(start_date = '', end_date = '', loc) {
                $('#po').DataTable({
                    ...
                    'order': [],
                    'ajax': {
                        'url': "<?php echo site_url('purchase/load_pur_report')?>",
                        'type': 'POST',
                        'data': {
